...
# ==============================================================================
"""Revised basic word2vec example for medical embeddings application."""
...
if __name__ == '__main__':
    ...
    filename = r'C:\Users\win\Desktop\test_data_med\d2bow.txt'
    vocabulary = read_data(filename)
    print('Data size', len(vocabulary))

    # Step 2: Build the dictionary and replace rare words with UNK token.
    vocabulary_size = 4200
    data, count, dictionary, reverse_dictionary = build_dataset(vocabulary, vocabulary_size)
    del vocabulary  # Hint to reduce memory.
    print('Most common words (+UNK)', count[:5])
    print('Sample data', 'index:', data[:10], 'key:', [reverse_dictionary[i] for i in data[:10]])
    ...
    try:
        ...
        labels = [dict_med[reverse_dictionary[i]] for i in xrange(plot_only)]
        plot_with_labels(low_dim_embs, labels, os.path.join(os.getcwd(), 'med2rep_32.png'))
